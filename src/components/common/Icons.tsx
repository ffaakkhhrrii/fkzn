...
/**
 * Icon Components
 * SVG icons for social links and UI elements
 */
...
export const RocketIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    ...
    className={className}
  >
    <path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.08-2.91a2.18 2.18 0 0 0-2.92-.09z" />
    <path d="M12 15l-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z" />
    <path d="M9 12H4s.55-3.18 2.5-5A2.99 2.99 0 0 1 12 5" />
    <path d="M12 15v5s3.18-.55 5-2.5A2.99 2.99 0 0 0 19 12" />
  </svg>
);

export const ChipIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
